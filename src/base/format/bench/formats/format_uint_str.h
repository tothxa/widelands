...
static const std::vector<std::string> formats_uint_str = {
"[Host]: disconnect_player_controller(%u, %s)\n",
"Invalid category %u for addon %s",
...
"%1$u add-on with wrong version: %2$s",
"%1$u missing add-on: %2$s",
"%1$u missing add-ons: %2$s"
};
